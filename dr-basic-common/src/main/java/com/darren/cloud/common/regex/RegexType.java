package com.darren.cloud.common.regex;
...
public final class RegexType implements Serializable {
    ...
    public static final String PHONE_TERMINAL_REGEX =
            "\\b(ip(hone|od)|android|opera m(ob|in)i" + "|windows (phone|ce)|blackberry" + "|s(ymbian|eries60|amsung)|p(laybook|alm|rofile/midp"
     ...
     * </p>
     */
    public static final String DATE_BASIC = DATE_YYYY_MM_DD_HH_MM_SS + "|" + DATE_YYYY_MM_DD + "|" + DATE_YYYY_MM_DD_HH_MM_SS_2 + "|" + DATE_YYYY_MM_2
